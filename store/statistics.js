  ...
  statistics: [
    {
      ...
      "description":"Каждый 3-й в стране уверен, что рак неизлечим. А это примерно 48 918 000 человек.",
      "oldValue":null,
    ...
    },
    {
      ...
      "description":"На 28% выросла доля выявления заболеваний на ранней стадии за 10 лет.",
      "oldValue":10,
      "currentValue":30,
      "maxValue":100,
    ...
    },
    {
      ...
      "summary":"↓25%",
      "source":"МНИОИ Герцена 2018",
      "description":"На 25% снизилась смертность в течение первого года после постановки диагноза.",
      "oldValue":10,
      "currentValue":2,
      "maxValue":100,
